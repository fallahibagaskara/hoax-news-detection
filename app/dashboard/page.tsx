        ...
        <Card className="col-span-4">
          ...
          <CardContent>
            <div className="space-y-8">
              {[
                { title: "Fake Celebrity Death Hoax", url: "https://example.com/news1", confidence: 98 },
                { title: "Misleading Political Statement", url: "https://example.com/news2", confidence: 87 },
                { title: "False Medical Claim", url: "https://example.com/news3", confidence: 95 },
              ].map((item, index) => (
