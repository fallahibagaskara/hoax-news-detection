            ...
            <div className="container mx-auto px-4 py-24 md:py-32 lg:py-40 relative">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Masukkan tautan artikel berita yang ingin Anda periksa</p>
                    </div>
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h3 className="text-xl font-bold mb-2">Analisis Pola Bahasa</h3>
                        <p className="text-gray-500 dark:text-gray-400">Sistem akan menganalisis konten untuk mencari tanda-tanda kesalahan informasi</p>
                    </div>
                    <div className="flex flex-col items-center text-center">
